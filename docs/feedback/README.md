...
1. 通过[Github issues](https://github.com/HCLonely/auto-task/issues/new/choose)进行反馈
2. 通过[其乐论坛](https://keylol.com/t455167-1-1)进行反馈
...
- 提交 BUG 前请先确认：
  ...
  3. 如果你使用的是正式版，提交 BUG 前查看[测试版更新记录](https://github.com/hclonely/auto-task/releases)但没有解决此问题的记录
- 提交 BUG 时请提供以下信息：
