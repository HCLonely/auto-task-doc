...
1. Feedback by [Github issues](https://github.com/HCLonely/auto-task/issues/new/choose)
2. Feedback through [Keylol Forum](https://keylol.com/t455167-1-1)
...
- Please confirm before submitting BUG：
  ...
  3. If you are using the official version, check the [pre version update record](https://github.com/hclonely/auto-task/releases) before submitting the bug, but there is no record of solving this problem
